...
from capyface_commons.generated import user_service_pb2 as user__service__pb2
...
class UserServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.ValidateToken = channel.unary_unary(
                '/capyface.user.UserService/ValidateToken',
...
def add_UserServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'capyface.user.UserService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('capyface.user.UserService', rpc_method_handlers)
